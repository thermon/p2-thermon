...
if (strpos($_SERVER['HTTP_USER_AGENT'], 'Mac') !== false) {
    ...
    $STYLE['read_fontsize'] = "14px"; // ("13px") スレッド内容表示のフォントの大きさ
    $STYLE['respop_fontsize'] = "14px"; // ("12px") 引用レスポップアップ表示のフォントの大きさ
...
$STYLE['textcolor'] = "#d6e9ca"; // ("#000") 基本 テキスト色
...
$STYLE['menu_color'] = "#d6e9ca"; //("#000") menu テキスト色
$STYLE['menu_cate_color'] = "#d6e9ca"; // ("#333") メニューカテゴリーの色

$STYLE['menu_acolor_h'] = "#ffffaf"; // ("#09c") メニュー マウスオーバー時のリンク色

$STYLE['menu_ita_color'] = "#bae4a6"; // ("") メニュー 板 リンク色
...
$STYLE['sb_color'] = "#d6e9ca";  // ("#000") subject テキスト色
...
$STYLE['sb_tbgcolor_nosubject'] = "#1f3f2f"; // ("#eef") subject テーブル内背景色（dat倉庫）
$STYLE['sb_tbackground'] = ""; // ("") subject テーブル内背景画像0
$STYLE['sb_tbackground1'] = ""; // ("") subject テーブル内背景画像1

$STYLE['sb_ttcolor'] = "#d6e9ca"; // ("#333") subject テーブル内 テキスト色
...
$STYLE['thre_title_color'] = "#d6e9ca"; // ("#000") subject スレタイトル リンク色
$STYLE['thre_title_color_v'] = "#46845b"; // ("#999") subject スレタイトル 訪問済みリンク色
...
$STYLE['sb_tool_color'] = "#46845b"; // ("#d6e7ff") subject ツールバー内 文字色
$STYLE['sb_tool_acolor'] = "#afffaf"; // ("#d6e7ff") subject ツールバー内 リンク色
...
$STYLE['sb_now_sort_color'] = "#afffaf";   // ("#1144aa") subject 現在のソート色

$STYLE['sb_thre_title_new_color'] = "#ff0"; // ("red") subject 新規スレタイトルの色

$STYLE['sb_tool_newres_color'] = "#afffaf"; // ("#ff3300") subject ツールバー内 新規レス数の色
$STYLE['sb_newres_color'] = "#afffaf"; // ("#ff3300") subject 新着レス数の色
...
$STYLE['respop_color'] = "#d6e9ca"; // ("#000") レスポップアップのテキスト色
